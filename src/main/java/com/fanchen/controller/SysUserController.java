...
import com.fanchen.common.lang.OssTemplate;
...
public class SysUserController extends BaseController<SysUser> {
    ...
    public Result avatar(@RequestParam("avatarFile")MultipartFile file, @RequestParam("user") String userJson) throws IOException {
   /*     if (!file.isEmpty()){
        ...
        System.out.println("文件上传之后的路径是:" + filepath);
